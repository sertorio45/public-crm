...
return [
    ...
    | classe de validação. Algumas dessas regras têm várias versões, como as
    ...
    */
    ...
    | especificação de uma linha de linguagem personalizada específica para uma regra de atributo fornecida.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para substituir o espaço reservado de atributos

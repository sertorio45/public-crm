...
return [
            ...
            'index' => [
                ...
                'empty-placeholders' => [
                    'all' => [
                        ...
                        'description' => 'Nenhuma atividade foi encontrada para isso. Você pode adicionar atividades clicando no botão no painel esquerdo.',
                    ],

                    'planned' => [
                        'title'       => 'Nenhuma Atividade Planejada Encontrada',
                        'description' => 'Nenhuma atividade planejada foi encontrada para isso. Você pode adicionar atividades planejadas clicando no botão no painel esquerdo.',
                    ],

                    'notes' => [
                        'title'       => 'Nenhuma Nota Encontrada',
                        'description' => 'Nenhuma nota foi encontrada para isso. Você pode adicionar notas clicando no botão no painel esquerdo.',
                    ],

                    'calls' => [
                        'title'       => 'Nenhuma Chamada Encontrada',
                        'description' => 'Nenhuma chamada foi encontrada para isso. Você pode adicionar chamadas clicando no botão no painel esquerdo.',
                    ],

                    'meetings' => [
                        'title'       => 'Nenhuma Reunião Encontrada',
                        'description' => 'Nenhuma reunião foi encontrada para isso. Você pode adicionar reuniões clicando no botão no painel esquerdo.',
                    ],

                    'lunches' => [
                        'title'       => 'Nenhum Almoço Encontrado',
                        'description' => 'Nenhum almoço foi encontrado para isso. Você pode adicionar almoços clicando no botão no painel esquerdo.',
                    ],

                    'files' => [
                        'title'       => 'Nenhum Arquivo Encontrado',
                        'description' => 'Nenhum arquivo foi encontrado para isso. Você pode adicionar arquivos clicando no botão no painel esquerdo.',
                    ],

                    'emails' => [
                        'title'       => 'Nenhum Email Encontrado',
                        'description' => 'Nenhum email foi encontrado para isso. Você pode adicionar emails clicando no botão no painel esquerdo.',
                    ],
    ...
    'quotes' => [
        'index' => [
            ...
            'delete-failed'  => 'Cotação não pode ser excluída.',

            'datagrid' => [
                'subject'        => 'Assunto',
                'sales-person'   => 'Vendedor',
                'expired-at'     => 'Expirou em',
    ...
    'contacts' => [
        'persons' => [
            'index' => [
                ...
                'delete-failed'  => 'Pessoa não pode ser excluída.',
        ...
        'organizations' => [
            'index' => [
                ...
                'delete-failed'  => 'Organização não pode ser excluída.',
                ...
                'datagrid' => [
                    ...
                    'id'            => 'ID',
                    'name'          => 'Nome',
                    'persons-count' => 'Contagem de Pessoas',
                ],
            ],
    ...
    'settings' => [
        ...
        'groups' => [
            'index' => [
                ...
                'delete-failed'     => 'Grupo não pode ser excluído.',
        ...
        'types' => [
            'index' => [
                ...
                'delete-failed'  => 'Tipo não pode ser excluído.',
        ...
        'workflows' => [
            'index' => [
                ...
                'delete-failed'  => 'Workflow não pode ser excluído.',
                'datagrid'       => [
                    'delete'      => 'Excluir',
                    'description' => 'Descrição',
                    'edit'        => 'Editar',
            ...
            'helpers' => [
                ...
                'send-email-to-sales-owner'  => 'Enviar email para o proprietário de vendas',
                'send-email-to-participants' => 'Enviar email para os participantes',
                'add-webhook'                => 'Adicionar Webhook',
                'update-lead'                => 'Atualizar Lead',
                'update-person'              => 'Atualizar Pessoa',
                'send-email-to-person'       => 'Enviar email para a pessoa',
            ...
            'create' => [
                ...
                'description'            => 'Descrição',
                'actions'                => 'Ações',
                'basic-details-info'     => 'Coloque as informações básicas do workflow.',
                'event-info'             => 'Um evento dispara, verifica, condições e executa ações predefinidas.',
                'conditions'             => 'Condições',
                'conditions-info'        => 'Condições são regras que verificam cenários, desencadeadas em ocasiões específicas.',
                'actions-info'           => 'Uma ação não apenas reduz a carga de trabalho, mas também facilita bastante a automação do CRM',
                'value'                  => 'Valor',
        ...
        'webforms' => [
            'index' => [
                ...
                'delete-failed'  => 'Formulário Web não pode ser excluído.',
        ...
        'email-template' => [
            'index' => [
                ...
                'delete-failed'  => 'Modelo de Email não pode ser excluído.',
        ...
        'tags' => [
            'index' => [
                ...
                'delete-failed'  => 'Tag não pode ser excluída.',
        ...
        'users' => [
            'index' => [
                ...
                'delete-failed'       => 'Usuário não pode ser excluído.',
        ...
        'pipelines' => [
            'index' => [
                ...
                'delete-failed'        => 'Pipeline não pode ser excluído.',
            ...
            'create' => [
                ...
                'add-stage-info'       => 'Adicionar nova etapa para o seu Pipeline',
        ...
        'warehouses' => [
            'index' => [
                ...
                'delete-failed'  => 'Armazém não pode ser excluído.',
        ...
        'attributes' => [
            'index' => [
                ...
                'delete-failed'      => 'Atributos não podem ser excluídos.',
    ...
    'activities' => [
        ...
        'delete-failed'        => 'Atividade não pode ser excluída.',
    ],
    ...
    'mail' => [
        ...
        'delete-failed'       => 'Email não pode ser excluído.',
        ...
        'view' => [
            ...
            'forward'                    => 'Encaminhar',
            'delete'                     => 'Excluir',
            'enter-mails'                => 'Digite o ID do email',
            'rotten-days'                => 'O lead está podre há :days dias',
    ...
    'layouts' => [
        ...
        'workflows'            => 'Workflows',
        'workflows-info'       => 'Adicionar, editar ou excluir workflows do CRM',
        'other-settings'       => 'Outras Configurações',
    ...
    'user' => [
        'account' => [
            ...
            'upload_image_format'   => 'no formato PNG ou JPG',
